...
Usage:
  ...
  optional: --width-ratio 0.60 --v-center 0.40 --overlay 0.22 --brightness 0.97
...
def main():
    ...
    ap.add_argument("--v-center", type=float, default=0.40, help="title vertical center as ratio of height")
